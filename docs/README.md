# Documentation
This is allegedly where i'd put all the document stuff. i will record anything i think might be useful but here are a few questions to encourage documentation and stuff:
- What do i want?
	- ok this is vague, moving to ideas
- What works (according to other people)?
	- this fits under noted
- What have i tried?
	- noted
...
How to do this? I can begin with guides online and asking questions to people who know how to use it. I can take things by steps. instead of trying to amass all this knowledge into the final design, try stuff, do bad, learn and then apply it to the final PCB design or whatever. Maybe learn basic usb stuff, try basic routing and catch mistakes. I tend to be thorough with things checking stuff over, checking over is *ok* but i shouldn't do it in fear that what it is i'm checking isn't going to turn out perfect. 
